...
export default function SignupPage() {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Mock success - set both localStorage and cookie
      ...
      >
        <div className="glass-strong p-8 rounded-2xl">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400">Start building stunning websites today</p>
          </div>
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-4">
              <button className="glass px-4 py-3 rounded-lg hover:glass-strong transition-all flex items-center justify-center gap-2">
